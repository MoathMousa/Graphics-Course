...
public class LightLab  implements GLEventListener{
    
     private float angle;
     private float trans1;
     private float trans2;
...
//        
        ...
        float[] position = {-1f,1f,1f,1f};
        gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_POSITION,position,0);
        
        
        float[] color = {1,1f,0f,1f};
        gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_AMBIENT,color,0);
...
//         gl.glTranslatef(trans1, 0, 0);
       ...
       gl.glTranslatef(0.1f, 0.45f, 0);
        ...
        float[] position1 = {1f,1f,1f,1f};
        gl.glLightfv(GL2.GL_LIGHT1, GL2.GL_POSITION,position1,0);
        
        
        float[] color1 = {0f,1f,0f,1f};
        gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_AMBIENT,color1,0);
